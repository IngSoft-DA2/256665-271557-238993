...
public class ReportRepositoryTest
{
    ...
    public void GetMaintenanceReportByBuilding_ReturnsMaintenanceRequestsWhenBuildingFromQueryIsSetted()
    {
        ...
        IEnumerable<MaintenanceRequest> expectedMaintenanceRequests = new List<MaintenanceRequest> {maintenanceRequestInDb2};
    
        _dbContext.Set<MaintenanceRequest>().Add(maintenanceRequestInDb2);
        _dbContext.SaveChanges();
        
        IEnumerable<MaintenanceRequest> maintenanceRequestsResponse = _reportRepository.GetMaintenanceReportByBuilding(maintenanceRequestInDb2.ManagerId, maintenanceRequestInDb2.Flat.BuildingId);
